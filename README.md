...
### Installation
#### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/sasinosadrano/Ruwet-File-Double)</br>
...
#### Deploy in your VPS
````bash
git clone https://github.com/sasinosadrano/Ruwet-File-Double
cd DMS-File-Bot
...
[RUWET FILE](https://github.com/sasinosadrano/Ruwet-File-Double) is Free Software: You can use, study share and improve it at your
